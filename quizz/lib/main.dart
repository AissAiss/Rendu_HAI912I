...
void main() {
  runApp(
    const MaterialApp(home: QuizzPage(title: '',),),
  );
}
...
class SomeQuizzPageState extends State<QuizzPage> {
  ...
  Question question = Question(questionText: "1 + 1 = 2", isCorrect: true);
                  ...
                  onPressed: () {
                    setState(() {
                      if (hasAnwsered) {
                        ...
                        question = NewQuestion(); //Question(questionText: "9 + 2 = 92", isCorrect: false);
                        correct = Colors.blue;
                        wrong = Colors.blue;
                        hasAnwsered = false;
                      }
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('/home/aissaiss/StudioProjects/quizz/pics/quiz.png'),
  ...
  Question NewQuestion() {
    ...
    int firstInt = rng.nextInt(100);
    int secondInt = rng.nextInt(100);
    int answerInt;
    bool answer;
    ...
    if(rng.nextBool()){
      ...
      answerInt = rng.nextInt(100);
      answer = false;
    }
    return Question(questionText: "$firstInt + $secondInt = $answerInt ?" , isCorrect: answer);
  }
